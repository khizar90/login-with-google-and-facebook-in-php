          ...
          <form id="form-login" class="p-t-15" role="form" action="" method="post">
            ...
            <div class="row">
              ...
              <div class="col-md-6 d-flex align-items-center justify-content-end">
                <button aria-label="" class="btn btn-primary btn-lg m-t-10" type="submit" name="submit">Sign in</button>
              </div>
            </div>
            ...
            <div>
              <a href="register.php" class="normal">Not a member yet? Signup now.</a>
            </div>
            <!-- END Form Control-->
          </form>
          <!--END Login Form-->
