...
require_once 'googleapi/index.php';
require_once 'fb-init.php';

$register = new Register();
if(isset($_POST['submit'])){
    $result = $register->registration($_POST["fb_user_name"],$_POST["email"]);
    if($result == 1){
...
if (isset($accessToken))
{
	...
	try {
		...
		$result = $register->registration($fb_user->getProperty('name'),$fb_user->getProperty('email'));
...
{	
	...
	$fb_login_url = $fb_helper->getLoginUrl('http://localhost:8080/learnPHP/loginwithfacebook/index.php', $permissions);
}
?>
...
<html lang="en">
<head>
  <title>Login with Facebook or Google</title>
  <link rel="stylesheet" type="text/css" href="css\style.css">
  <link rel="stylesheet" type="text/css" href="googleapi\style.css">
  <!-- C:\xampp\htdocs\learnPHP\loginwithfacebook\loginwithgoogle\googleapi\style.css -->
  <meta charset="utf-8">
...
<?php if(isset($_SESSION['fb_user_id'])): 	?>
	...
	<h1> <center>you login with facebook<center></h1>
		...
		<form action="" method="post">
			...
			<?php
					  ...
					  echo '<div align="center">'.$login_button . '</div>';    
					     ?>
				<a href="<?php echo $fb_login_url;?>" name="submit" type="submit" class="btn btn-primary btn-block"><i class="fa fa-facebook"></i> Sign in with <b>Facebook</b></a>
			</div>
